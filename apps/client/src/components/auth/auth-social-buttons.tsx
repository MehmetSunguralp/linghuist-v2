...
const socialBtnClass =
  'flex items-center justify-center gap-3 rounded-xl border border-outline-variant/15 bg-surface-container-low px-4 py-3 text-sm font-bold tracking-tight text-on-surface transition-colors duration-200 hover:bg-surface-container active:scale-95';
